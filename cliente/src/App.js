      ...
      <Router>
        <div className="app-container">
          <Routes>
            ...
            <Route
                path={`/dashboard_comprador/${currentUser}`}
            ...
            <Route
                path={`/dashboard_vendedor/${currentUser}`}
                element={<DashboardVendedor />}
            />
            <Route path={`/vender/${currentUser}`} element={<AnunciarVenda />} />
            <Route
                path={`/infraestrutura/${currentUser}`}
                element={<Addinfraestrutura />}
            />
