...
export default function DashboardAdmin() {
                ...
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <div>
                    <h1 className="text-success counter">
                      {(totalGasto + totalGasto * valor).toFixed(2)}€
                    </h1>
  ...
  function Titulo() {
    ...
    console.log(conta);
    if (conta >= 1) {
      return <p className="h2 text-center mb-4">Validações de Contrato</p>;
    }
  }
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div>
                        ...
                        <button
                          ...
                          onClick={() => sendUpdateFalse(data.idcontrato)}
                        >
                          Recusar
                        </button>
                      </div>
