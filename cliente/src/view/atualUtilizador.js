...
export default function AtualUtilizador() {
  ...
  return (
    <li className="nav-item dropdown">
      ...
      >
        <li>
          <Link className="dropdown-item" to={`/dadosconta/${currentUser}`}>
            <i class="fa-sharp fa-solid fa-user me-2"></i>Perfil
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link className="dropdown-item" to={`/iniciarsessao/`}>
            <i class="fa-sharp fa-solid fa-right-from-bracket me-2"></i>Sair
          </Link>
        </li>
      </ul>
    </li>
