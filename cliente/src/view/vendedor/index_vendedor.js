...
export default function DashboardVendedor() {
  ...
  const handleClick = () => {
    ...
    var content =
      "CONTRATO DE TROCA DE EXCEDENTE ENERGÉTICO\n\n" +
      "Eu, [                                      ], COMPRADOR,\n" +
      "e eu, [                                      ], VENDEDOR,\n" +
                  ...
                  <div className="card-body">
                    ...
                    <ul className="list-unstyled my-3 p-0">
                      ...
                      <li>
                        <p>
                          Produção Vendida:{" "}
                          {(data.potenciaproduto * 0.8).toFixed(2)} kW
                        </p>
                      </li>
                      <li>
    ...
    return dataUtilizadores.map((dataU, index) => {
      if (dataU.iduser == currentUser) {
        return dataContratos.map((data, index) => {
          if (
            data.utilizadorIdV == currentUser &&
            data.infraestrutura.utilizadoreIduser == data.utilizadorIdV
          ) {
                      ...
                      <form className="row g-3 needs-validation" noValidate>
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="form-group input-group">
                            <input
                              value={campcapacidadegeracao}
                              onChange={(value) =>
                                setcampcapacidadegeracao(value.target.value)
                              }
                              type="text"
                              className="form-control"
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="form-group input-group">
                            <input
                              value={campareadeproducao}
                              onChange={(value) =>
                                setcampareadeproducao(value.target.value)
                              }
                              type="text"
                              className="form-control"
                        ...
                        <div className="col-md-6">
                          ...
                          <input
                            value={camptipoproducao}
                            onChange={(value) =>
                              setcamptipoproducao(value.target.value)
                            }
                            type="text"
                            className="form-control"
                            id="validationCustom02"
                        ...
                        <div className="col-md-12">
                          <label
                            ...
                            className="form-label"
                          >
                            Morada da Infraestrutura
                          </label>
                          <input
                            value={campmorada}
                            onChange={(value) =>
                              setcampmorada(value.target.value)
                            }
                            type="text"
                            className="form-control"
                            id="validationCustom02"
            ...
            <tr>
              ...
              <td>
                <Link
                  ...
                  onClick={() => [
                    setShowModal(true),
                    detailInfra(data.idinfraestrutura),
                  ]}
                >
                  <span className="btn-inner">
                    <svg
              ...
              <td>
                <Link
                  type="button"
                  className="btn btn-outline-danger btn-sm"
                  onClick={() => OnDeleteInfra(data.idinfraestrutura)}
                >
                  <span className="btn-inner">
                    <i class="fa-solid fa-trash"></i>
                  </span>
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div>
                        <h1 className="text-success counter">
                          {(data.totalGanho + data.totalGanho * valor).toFixed(
                            2
                          )}{" "}
                          €
                        </h1>
  ...
  function OnDeleteInfra(id) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        Swal.fire("Cancelado", "A infraestrutura não foi apagada.", "error");
      }
    });
  }
  ...
  function OnDeleteVenda(id) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        Swal.fire("Cancelado", "A venda não foi apagada.", "error");
      }
    });
  }
                ...
                <div className="col-md-12">
                  <div className="flex-wrap d-flex justify-content-between align-items-center">
                    <div>
                      <h1>VENDEDOR</h1>
                      <p>
                        Aqui poderá efetuar as vendas do seu excedente
                        energético e ver as estatísticas!
                      </p>
                    </div>
                    <div>
                      <img
              ...
              <div className="row row-cols-1 text-center">
                <div className="overflow-hidden d-slider1 ">
                  <ul className="p-0 m-0 mb-2 swiper-wrapper list-inline">
                    <li
                      className="swiper-slide card card-slide col-3 mx-2"
                      style={{ backgroundColor: "#A3ADF4" }}
                    >
