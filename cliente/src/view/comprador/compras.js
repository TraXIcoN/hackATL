...
export default function Compras() {
  ...
  function EstatisticasCompra() {
    return dataContratos.map((data, index) => {
      ...
      const ofertaCorrespondente = dataOfertasLoad.find(
        (dataO) => data.ofertaIdoferta === dataO.idoferta
      );
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="text-center">
                          {ofertaCorrespondente.preco} €/mês
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className="text-center">
                          {ofertaCorrespondente.potencia} kW/h
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className="text-center">
                          {ofertaCorrespondente.duracao} meses
                        </td>
                      </tr>
                      <tr>
                        <td>
                  ...
                  <div className="p-0 card-body">
                    <div className="mt-4 table-responsive">
                      ...
                      >
                        ...
                        <tbody>{EstatisticasCompra()}</tbody>
                      </table>
                    </div>
                  </div>
                </div>
