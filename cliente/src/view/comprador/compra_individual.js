      ...
      if (dataC.ofertaIdoferta == compraId) {
        return dataUtilizadores.map((dataU, index) => {
          ...
          if (dataU.iduser == dataC.utilizadorIdC) {
            ...
            dataU.consumoComprador =
              dataU.consumoComprador + dataOfertas.potenciaproduto;
            sendUpdateC(
              dataU.iduser,
              dataU.nCompras,
              dataU.gastoComprador,
              dataU.consumoComprador
            );
          }
        });
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-sm-12">
                      ...
                      <p>
                        Está prestes a comprar excedente energético de um
                        vendedor. Abaixo poderá confirmar os dados do serviço
                        que escolheu. Posteriormente terá de fazer o download do
                        contrato e dar o seu upload para que um admin possa o
                        validar. Por fim poderá pagar.
                      </p>
                    </div>
                  </div>
                  <div className="row">
                  ...
                  <div className="row">
                    <div className="col-sm-12">
                      <p className="mb-0 mt-4">
                        <svg
                          width={30}
                          className="text-primary mb-3 me-2 icon-30"
                          viewBox="0 0 30 30"
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                  ...
                  <div className="row mt-5">
                    <div className="col-sm-12">
                      ...
                      <p>
                        Por favor pague num prazo máximo até 7 dias. Obrigado
                        por comprar connosco.
                      </p>
                    </div>
                  </div>
